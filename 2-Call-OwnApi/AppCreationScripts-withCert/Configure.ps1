...
Function ConfigureApplications
{
   ...
   $clientAadApplication = New-MgApplication -DisplayName "daemon-console-v2" `
    ...
    # JSON is auto-generated.
    $appSettingsObject.AzureAd = ConvertFrom-Json "{""Instance"":""https://login.microsoftonline.com/"",""Domain"":""Auto"",""TenantId"":""Auto"",""ClientId"":""Auto"",""WithSpaAuthCode"":false,""ClientCertificates"":[{""SourceType"":""StoreWithDistinguishedName"",""CertificateStorePath"":""CurrentUser/My"",""CertificateDistinguishedName"":""CN=daemon-console-v2""}],""ClientCapabilities"":[]}";
